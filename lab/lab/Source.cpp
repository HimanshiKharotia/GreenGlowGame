...
void hedge1()
{
    ...
    {
        theta = i * PI * i / 180;
        glVertex2f(90 + 45 * cos(theta) / 2, 150 + 45 * sin(theta) / 2);
    }
    glEnd();
    glLineWidth(1.5);
    glColor3f(0, 1, 0);
    ...
    {
        theta = i * PI * i / 180;
        glVertex2f(120 + 45 * cos(theta) / 2, 170 + 45 * sin(theta) / 2);
    }
    glEnd();
    glLineWidth(1.5);
    glColor3f(0, 1, 0);
    ...
    {
        theta = i * PI * i / 180;
        glVertex2f(143 + 45 * cos(theta) / 2, 170 + 45 * sin(theta) / 2);
    }
    glEnd();
    glLineWidth(1.5);
    glColor3f(0, 1, 0);
    ...
    {
        theta = i * PI * i / 180;
        glVertex2f(170 + 45 * cos(theta) / 2, 150 + 45 * sin(theta) / 2);
    }
    glEnd();
    glFlush();
}
void hedge2()
{
    ...
    {
        theta = i * PI * i / 180;
        glVertex2f(450 + 45 * cos(theta) / 2, 150 + 45 * sin(theta) / 2);
    }
    glEnd();
    glLineWidth(1.5);
    glColor3f(0, 1, 0);
    ...
    {
        theta = i * PI * i / 180;
        glVertex2f(480 + 45 * cos(theta) / 2, 170 + 45 * sin(theta) / 2);
    }
    glEnd();
    glLineWidth(1.5);
    glColor3f(0, 1, 0);
    ...
    {
        theta = i * PI * i / 180;
        glVertex2f(505 + 45 * cos(theta) / 2, 170 + 45 * sin(theta) / 2);
    }
    glEnd();
    glLineWidth(1.5);
    glColor3f(0, 1, 0);
    ...
    {
        theta = i * PI * i / 180;
        glVertex2f(530 + 45 * cos(theta) / 2, 150 + 45 * sin(theta) / 2);
    }
    glEnd();
    glFlush();
}
